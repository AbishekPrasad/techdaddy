...
import { FaInstagram, FaLinkedinIn, FaTwitter, FaPinterestP, FaYoutube } from 'react-icons/fa';
    ...
    <section id="home" className="min-h-screen flex items-center justify-center pt-28 pb-12 relative">
      <div className="max-w-5xl mx-auto text-center z-10">
        ...
        >
          ...
          <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="text-light hover:text-neon transition-colors duration-300">
